...
void CircuitFileWriter::updateComponentPositions(const std::string circuitFilePath, const Circuit& circuit)
{
	//{
  ...
  while (std::getline(inFile, lineStr)) {
    ...
    if (componentLine.isComponentLine) {
      auto componentInfo = circuit.componentNameToComponentMap.at(componentLine.componentName);
      outFile << fmt::format(
                "{}{}{}{}{}{}{},{}{}\n",
